...
### 3.2 타임라인
![Openmarket-Timeline](https://github.com/user-attachments/assets/73e8b87e-4626-4da0-a0ea-8415b366ae72)
...
## 8. 추후 개발 계획
  ...
  >> ▪ 재사용성을 위한 컴포넌트의 분리(API,function(validation 등))  
  >> ▪ Class문법으로 작성된 component function으로 변경  
  >> ▪ 라우터 별도 분리  
  >> ▪ 중복된 코드를 줄이고, 시맨틱한 코드 만들기( + CSS 리팩토링)  
